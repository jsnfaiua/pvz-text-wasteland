...
import { initScreenButtons, showScreen,
    initModalButtons } from './source-code/ui/screens.js?v=4.40';   // v4.40 cache-busting：screens.js 内动态 import workshop.js 带版本号，需强制刷新自身
...
export function initGame() {
    ...
    if (wroomCode && /^[A-Za-z0-9]{6}$/.test(wroomCode)) {
        import('./source-code/mod-wasteland/mpWasteland.js?v=4.40')
