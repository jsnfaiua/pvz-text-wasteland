// _cdp-grass-seasons.mjs — 四季草样式验证
...
async function main() {
    ...
    if (big.result && big.result.value) fs.writeFileSync('dev-tools/_cdp-grass-seasons.png', Buffer.from(big.result.value, 'base64'));
    console.log('已导出四季对比图');
